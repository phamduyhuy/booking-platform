 ...
 * 
 * Tools provided:
 * - get_customer_profile: Fetch authenticated user's profile for auto-filling
 * booking forms
 */
@Service
...
public class CustomerMcpToolService {
    ...
    public Map<String, Object> getCustomerProfile(
            @McpToolParam(description = "The unique identifier of the customer whose profile is to be fetched (userId) ") String userId) {
        ...
        try {
            ...
            if (customer.gender() != null) {
                result.put("gender", customer.gender());
            }
            ...
            if (customer.address() != null) {
                ...
                // Also put country at top level for easier access
                if (customer.address().country() != null) {
                    result.put("country", customer.address().country());
                }
            }
